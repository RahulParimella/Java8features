...
public class Emp {
	...
	public static void main(String args[]) {
		...
		//findfirst operation
		Optional<EmployeeDetails> findfirst = employeelist.stream().findFirst();
		 
		  System.out.println(findfirst.get());
		  //findany operation
		  Optional<EmployeeDetails> findany = employeelist.stream().findAny();
		  ...
		  //foreach
		     ...
		     employeelist.stream().sorted(new Comparator<EmployeeDetails>() {
...
System.out.println("---------------");
		     ...
		     employeelist.stream().sorted(new Comparator<EmployeeDetails>() {
		    	 public int compare(EmployeeDetails E1 , EmployeeDetails E2) {
		    		 return(int)(E2.employeeId - E1.employeeId);
		    	 }
		     }).collect(Collectors.toList()).forEach(System.out::println);
